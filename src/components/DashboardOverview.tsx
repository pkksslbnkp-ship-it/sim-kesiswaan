    ...
    <div className="space-y-6 font-sans">
          ...
          <div className="max-w-2xl space-y-3">
            ...
            <div className="pt-2 flex flex-wrap gap-3">
              <button
                ...
                className="px-5 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-500 text-white text-xs font-black shadow-lg shadow-blue-600/30 transition flex items-center space-x-2 uppercase tracking-wide cursor-pointer"
              >
              ...
              <button
                ...
                className="px-5 py-2.5 rounded-xl bg-indigo-950 hover:bg-indigo-900 text-indigo-300 text-xs font-bold border border-indigo-800/80 transition flex items-center space-x-2 cursor-pointer"
              >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-blue-600 text-white p-6 rounded-2xl flex items-center justify-between shadow-xs">
          ...
          <button 
            onClick={() => onNavigate('excel-upload')}
            className="bg-white text-blue-600 font-black py-2.5 px-6 rounded-xl hover:bg-blue-50 transition-colors text-xs uppercase tracking-wider cursor-pointer"
          >
            UNGGAH EXCEL
          </button>
        </div>
        ...
        <div className="bg-slate-900 text-white p-6 rounded-2xl flex items-center justify-between shadow-xs">
          ...
          <button 
            ...
            className="bg-slate-800 text-white border border-slate-700 font-black py-2.5 px-6 rounded-xl hover:bg-slate-700 transition-colors text-xs uppercase tracking-wider cursor-pointer"
          >
            PENGATURAN
          </button>
        </div>
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-xs">
          <div className="flex items-center justify-between pb-4 border-b border-slate-100">
            ...
            <button
              ...
              className="text-xs font-bold text-blue-600 hover:underline flex items-center cursor-pointer"
            >
